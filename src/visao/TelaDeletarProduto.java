...
public class TelaDeletarProduto extends JFrame {
	...
	public TelaDeletarProduto() {
		...
		contentPane.add(lblNewLabel, "cell 0 0 6 1,alignx center,aligny center");
		...
		lblCategoria.setFont(new Font("Hanken Grotesk", Font.BOLD, 18));
		panel_1.add(lblCategoria, "cell 0 0");
		
		JLabel lblNome = new JLabel("\"Nome\"");
		lblNome.setFont(new Font("Hanken Grotesk", Font.PLAIN, 18));
		panel_1.add(lblNome, "cell 0 1");
		
		JPanel panel = new JPanel();
		contentPane.add(panel, "cell 3 1 3 3,grow");
		...
		lblCor.setFont(new Font("Hanken Grotesk", Font.PLAIN, 18));
		panel_2.add(lblCor, "cell 0 0");
		
		JLabel lblTamanho = new JLabel("Tamanho: \"Tamanho\"");
		lblTamanho.setFont(new Font("Hanken Grotesk", Font.PLAIN, 18));
