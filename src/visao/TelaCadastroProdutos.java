...
public class TelaCadastroProdutos extends JFrame {
	...
	public TelaCadastroProdutos() {
		...
		contentPane.add(lblCadastrarProduto, "cell 0 0 5 1,growx");
		lblCadastrarProduto.setFont(hkGrotesk);
		
		JLabel lblId = new JLabel("Id");
		lblId.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblId, "cell 0 1,growx");
		...
		contentPane.add(lblNome, "cell 0 2,growx");
		...
		contentPane.add(lblMaterial, "cell 0 3,growx");
		...
		contentPane.add(panelimg, "cell 3 1 2 5,grow");
		
		JLabel lblCategoria = new JLabel("Categoria");
		lblCategoria.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblCategoria, "cell 0 4,growx");
		...
		contentPane.add(lblVariação, "cell 0 5,growx");
		...
		contentPane.add(lblValor, "cell 0 6,growx");
		...
		contentPane.add(lblFornecedor, "cell 3 6,growx");
		...
		contentPane.add(lblTamanho, "cell 0 7,growx");
		...
		JLabel lblQntEstoque = new JLabel("Quantidade");
		lblQntEstoque.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblQntEstoque, "cell 3 7,growx");
		...
		contentPane.add(btnCadastrarProduto, "cell 0 9 2 1,growx");
